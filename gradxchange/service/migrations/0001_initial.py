    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_price', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ('service_image', models.ImageField(default='notfound.png', upload_to='images_service')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('liked_by', models.ManyToManyField(blank=True, related_name='service_liked', to=settings.AUTH_USER_MODEL)),
